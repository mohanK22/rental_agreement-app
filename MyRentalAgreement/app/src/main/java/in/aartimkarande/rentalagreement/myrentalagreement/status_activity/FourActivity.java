    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validate) {
                    startActivity(new Intent(FourActivity.this, RentPaymentActivity.class));
                }
...
/*        if(TextUtils.isEmpty(rentID)){
    ...
    private void getIDs() {
        SharedPreferences sharedPreferences = FourActivity.this.getSharedPreferences(MyAppSharedPreferences.SHARED_PREF_NAME, Context.MODE_PRIVATE);
