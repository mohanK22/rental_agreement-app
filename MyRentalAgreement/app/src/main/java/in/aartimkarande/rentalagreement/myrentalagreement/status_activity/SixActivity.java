...
public class SixActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validate) {
                    startActivity(new Intent(SixActivity.this, AgreementSuccessActivity.class));
                }
    ...
    private void getIDs() {
        SharedPreferences sharedPreferences = SixActivity.this.getSharedPreferences(MyAppSharedPreferences.SHARED_PREF_NAME, Context.MODE_PRIVATE);
 ...
 /*       //Creating a shared preference
        ...
        editor.putString(IDTracker.TOKEN_ID, "1543336835026");
