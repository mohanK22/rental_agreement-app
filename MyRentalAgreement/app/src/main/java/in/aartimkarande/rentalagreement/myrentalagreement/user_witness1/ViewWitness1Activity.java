...
public class ViewWitness1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_witness1);
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if(Math.abs(deltaX) > FinalValues.MIN_DISTANCE){
                            ...
                            if(x2 > x1){
                                ...
                                startActivity(new Intent(ViewWitness1Activity.this, ViewWitness2Activity.class)
                                .putExtra("name", witness.getWit2_name())
                                .putExtra("dob", witness.getWit2_age())
                                .putExtra("gender", witness.getWit2_gender())
                                .putExtra("phone", witness.getWit2_mobno())
                                .putExtra("prof", witness.getWit2_prof())
                                .putExtra("pan", witness.getWit2_prof())
                                .putExtra("aadhar", witness.getWit2_aadhar())
                                .putExtra("add1", witness.getWit2_add1())
                                .putExtra("add2",witness.getWit2_add2()));
                            }
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ViewWitness1Activity.this, CreateAgreementDashboardActivity.class).putExtra("status", "update"));
            }
        });
    ...
    private void getWitnessData() {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ViewWitness1Activity.this);
    ...
    private void getPrivateSharedData() {
        SharedPreferences sharedPreferences = ViewWitness1Activity.this.getSharedPreferences(MyAppSharedPreferences.SHARED_PREF_NAME, Context.MODE_PRIVATE);
