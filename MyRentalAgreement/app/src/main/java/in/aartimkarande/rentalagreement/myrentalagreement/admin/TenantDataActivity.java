...
public class TenantDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tenantID = intent.getStringExtra("tentID");
    ...
    private void getTenantData() {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(TenantDataActivity.this);
