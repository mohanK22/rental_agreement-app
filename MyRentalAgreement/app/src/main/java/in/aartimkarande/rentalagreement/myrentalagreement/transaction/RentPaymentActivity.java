    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputEditTextCashAmt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(RentPaymentActivity.this,
...
//                datePickerDialog.getDatePicker().setMaxDate(maxDate);
            ...
            public void onClick(View v) {
                ...
                if(isDepositAmtPaid.equalsIgnoreCase("Yes")){
                    ...
                    if(paymentMode.equalsIgnoreCase("Cash")){
                        ...
                        chqAmt = inputEditTextChqAmt.getText().toString();
                        if(TextUtils.isEmpty(chqAmt)){
                            textInputLayoutChqAmt.setError("Enter Cheque Number");
    ...
    private void showConfirmationMsg() {
        ...
        builder.setPositiveButton(R.string.confirm_yes, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                alertDialog.dismiss();
                startActivity(new Intent(RentPaymentActivity.this, CreateAgreementDashboardActivity.class).putExtra("status", "update"));
            }
        });
    ...
    private void getPropertyID() {
        SharedPreferences sharedPreferences = RentPaymentActivity.this.getSharedPreferences(MyAppSharedPreferences.SHARED_PREF_NAME, Context.MODE_PRIVATE);
        propertyID = sharedPreferences.getString(IDTracker.PROP_ID,null);
    }

    private void senData() {

        StringRequest request = new StringRequest(Request.Method.POST, APIURLLists.RENT_URL,
                        ...
                        if (!response.equalsIgnoreCase(FinalValues.ERROR_MSG)) {
                            ...
                            handler.postDelayed(new Runnable() {
                                public void run() {
                                    ...
                                    Intent tenantIntent = new Intent(RentPaymentActivity.this, AgreementPaymentActivity.class);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(RentPaymentActivity.this);
    ...
    protected void onResume() {
        ...
        if(propertyID == null){
            startActivity(new Intent(RentPaymentActivity.this, PropertyActivity.class));
        }

        if(ownerID == null){
            startActivity(new Intent(RentPaymentActivity.this, OwnerActivity.class));
        }

        if(tenantID == null){
            startActivity(new Intent(RentPaymentActivity.this, TenantActivity.class));
        }

        if (witnessID == null){
            startActivity(new Intent(RentPaymentActivity.this, Witness1Activity.class));
        }
        ...
        if(rentID != null) {
            ...
            if(rentTransID != null){
                startActivity(new Intent(RentPaymentActivity.this, ViewRentPaymentActivity.class));
            }else{
                ...
                builder.setPositiveButton(R.string.confirm_yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        alertDialog.dismiss();
                        startActivity(new Intent(RentPaymentActivity.this, EditRentPaymentActivity.class));
                    }
                });
                builder.setNegativeButton(R.string.confirm_cancel, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        alertDialog.dismiss();
                        startActivity(new Intent(RentPaymentActivity.this, AgreementPaymentActivity.class));
                    }
                });
                alertDialog = builder.create();
                alertDialog.show();
