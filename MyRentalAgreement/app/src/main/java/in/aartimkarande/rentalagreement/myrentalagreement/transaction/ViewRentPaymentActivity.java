...
public class ViewRentPaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_rent_payment);
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (Math.abs(deltaX) > FinalValues.MIN_DISTANCE) {
                            ...
                            if (x2 > x1) {
                                ...
                                startActivity(new Intent(ViewRentPaymentActivity.this, ViewAgreementPaymentActivity.class));
                            }
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ViewRentPaymentActivity.this, CreateAgreementDashboardActivity.class).putExtra("status", "update"));
            }
        });
    ...
    private void getRentData() {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ViewRentPaymentActivity.this);
    ...
    private void getPrivateSharedData() {
        SharedPreferences sharedPreferences = ViewRentPaymentActivity.this.getSharedPreferences(MyAppSharedPreferences.SHARED_PREF_NAME, Context.MODE_PRIVATE);
