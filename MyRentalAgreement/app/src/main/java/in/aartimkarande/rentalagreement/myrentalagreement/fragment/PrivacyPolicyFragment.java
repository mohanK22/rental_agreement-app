...
public class PrivacyPolicyFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        textViewPrivacyPolicy = view.findViewById(R.id.privacy_policy_content);
        textViewPrivacyPolicy.setText(getResources().getString(R.string.privacy_policy_content));
