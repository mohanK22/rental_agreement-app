 ...
 * {@link TermsOfUseFragment.OnFragmentInteractionListener} interface
...
public class TermsOfUseFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        textViewTermsOfUse = view.findViewById(R.id.terms_of_use_contents);
        textViewTermsOfUse.setText(getResources().getString(R.string.terms_of_use_content));
